...
public class PetClinicWebConfig implements WebMvcConfigurer {
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
        ...
        String wepappFolder = "webapp";
        String indexForward = String.format("forward:/%s/index.html", wepappFolder);
        String indexRedirect = String.format("redirect:/%s/index.html", wepappFolder);
        ...
        for (String angularRoute : angularRoutes) {
            registry.addViewController(String.format("/%s/%s/**", wepappFolder, angularRoute))
